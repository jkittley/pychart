...
Helping people discover libraries
...
.. code-block:: bash
    ...
    cd pychart
    celery -A pychart.taskapp worker -l info
...
To run the tests, enter the pychart/tests directory and run the following commands::
